...
var file_user_service_internal_conf_conf_proto_rawDesc = []byte{
	...
	0x6f, 0x6b, 0x65, 0x6e, 0x4b, 0x65, 0x79, 0x42, 0x45, 0x5a, 0x43, 0x67, 0x69, 0x74, 0x68, 0x75,
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x74, 0x6f, 0x6f, 0x6d, 0x61, 0x6e, 0x79, 0x73, 0x6f, 0x75,
	0x72, 0x63, 0x65, 0x2f, 0x61, 0x74, 0x72, 0x65, 0x75, 0x73, 0x2f, 0x61, 0x70, 0x70, 0x2f, 0x75,
...
var file_user_service_internal_conf_conf_proto_goTypes = []interface{}{
	...
	(*Client_Relation)(nil),     // 7: user.service.internal.conf.Client.Relation
	(*Data_Database)(nil),       // 8: user.service.internal.conf.Data.Database
	(*Data_Redis)(nil),          // 9: user.service.internal.conf.Data.Redis
	(*Data_Kafka)(nil),          // 10: user.service.internal.conf.Data.Kafka
	(*JWT_Http)(nil),            // 11: user.service.internal.conf.JWT.Http
	(*JWT_Grpc)(nil),            // 12: user.service.internal.conf.JWT.Grpc
...
var file_user_service_internal_conf_conf_proto_depIdxs = []int32{
	...
	5,  // 4: user.service.internal.conf.Server.http:type_name -> user.service.internal.conf.Server.HTTP
	6,  // 5: user.service.internal.conf.Server.grpc:type_name -> user.service.internal.conf.Server.GRPC
	7,  // 6: user.service.internal.conf.Client.relation:type_name -> user.service.internal.conf.Client.Relation
	8,  // 7: user.service.internal.conf.Data.database:type_name -> user.service.internal.conf.Data.Database
	9,  // 8: user.service.internal.conf.Data.redis:type_name -> user.service.internal.conf.Data.Redis
	10, // 9: user.service.internal.conf.Data.kafka:type_name -> user.service.internal.conf.Data.Kafka
	11, // 10: user.service.internal.conf.JWT.http:type_name -> user.service.internal.conf.JWT.Http
	12, // 11: user.service.internal.conf.JWT.grpc:type_name -> user.service.internal.conf.JWT.Grpc
	13, // 12: user.service.internal.conf.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	13, // 13: user.service.internal.conf.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	13, // 14: user.service.internal.conf.Data.Redis.read_timeout:type_name -> google.protobuf.Duration
	13, // 15: user.service.internal.conf.Data.Redis.write_timeout:type_name -> google.protobuf.Duration
	13, // 16: user.service.internal.conf.Data.Kafka.read_timeout:type_name -> google.protobuf.Duration
	13, // 17: user.service.internal.conf.Data.Kafka.write_timeout:type_name -> google.protobuf.Duration
