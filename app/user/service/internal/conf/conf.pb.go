...
var file_user_service_internal_conf_conf_proto_rawDesc = []byte{
	...
	0x74, 0x22, 0x89, 0x01, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x45, 0x0a, 0x08, 0x64, 0x61,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x22, 0xc3, 0x01,
...
var file_user_service_internal_conf_conf_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_user_service_internal_conf_conf_proto_goTypes = []interface{}{
	...
	(*JWT_Http)(nil),            // 7: user.service.internal.conf.JWT.Http
	(*JWT_Grpc)(nil),            // 8: user.service.internal.conf.JWT.Grpc
...
var file_user_service_internal_conf_conf_proto_depIdxs = []int32{
	...
	7,  // 6: user.service.internal.conf.JWT.http:type_name -> user.service.internal.conf.JWT.Http
	8,  // 7: user.service.internal.conf.JWT.grpc:type_name -> user.service.internal.conf.JWT.Grpc
	9,  // 8: user.service.internal.conf.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	9,  // 9: user.service.internal.conf.Server.GRPC.timeout:type_name -> google.protobuf.Duration
